...
/**
 * The BBQChicken class represents a BBQChicken pizza, extending the Pizza class. This class includes a predefined set of toppings, it can be customized with a Crust and Size, and the price varies depending on the selected size.
...
public class BBQChicken extends Pizza{
    ...
    /**
     * Creates a BBQChicken pizza with the specified crust and a default size.
     *
     * @param crust crust type for the pizza.
     */
    public BBQChicken(Crust crust){
        super(new ArrayList<>(Arrays.asList(Topping.BBQ_CHICKEN,Topping.GREEN_PEPPER,Topping.PROVOLONE,Topping.CHEDDAR)),crust);
    }
